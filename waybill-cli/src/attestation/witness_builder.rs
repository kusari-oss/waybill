...
use waybill_common::attestation::network::{Connection as MikebomConnection, Protocol};
use waybill_common::attestation::witness::{
...
mod tests {
    use super::*;
    use waybill_common::attestation::file::{FileAccess, FileAccessSummary, FileOperation};
    use waybill_common::attestation::integrity::TraceIntegrity;
    use waybill_common::attestation::network::{
