...
pub(super) fn symbol_match_to_entry(
    ...
    let purl = waybill_common::types::purl::Purl::new(&m.target_purl).ok()?;
...
pub(super) fn version_match_to_entry(
    ...
    let purl_str = format!(
        "pkg:generic/{}@{}",
        waybill_common::types::purl::encode_purl_segment(m.library.slug()),
        waybill_common::types::purl::encode_purl_segment(&m.version),
    );
...
pub(crate) struct BinaryScan {
    ...
    /// emission time.
    pub binary_role: waybill_common::resolution::BinaryRole,
}
...
pub(super) fn make_file_level_component(
    ...
    let encoded_filename = waybill_common::types::purl::encode_purl_segment(&filename);
...
pub(super) fn note_package_to_entry(
    ...
    let encoded_name = waybill_common::types::purl::encode_purl_segment(&note.name);
    let encoded_version = waybill_common::types::purl::encode_purl_segment(&note.version);
...
mod tests {
    ...
    fn fake_binary_scan() -> BinaryScan {
        BinaryScan {
            ...
            binary_role: waybill_common::resolution::BinaryRole::Application,
        }
    }
    ...
    fn cargo_auditable_packages_to_entries_emits_per_crate_components() {
        ...
        let file_level_purl = waybill_common::types::purl::Purl::new(
