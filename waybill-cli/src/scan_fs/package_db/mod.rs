...
pub struct PackageDbEntry {
    ...
    /// `requirements.txt`).
    pub lifecycle_scope: Option<waybill_common::resolution::LifecycleScope>,
    ...
    pub binary_role: Option<waybill_common::resolution::BinaryRole>,
...
fn apply_go_production_set_filter(
    ...
    if !include_dev {
        ...
        entries.retain(|e| {
            ...
            !waybill_common::resolution::lifecycle_scope_is_legacy_dev(&e.lifecycle_scope)
        });
...
fn apply_go_build_inclusion_unknown_markers(
    ...
    use waybill_common::resolution::{BuildInclusion, LifecycleScope};
...
",
    ...
    fn scope_of<'a>(
        ...
        name: &str,
    ) -> &'a Option<waybill_common::resolution::LifecycleScope> {
        &entries
            .iter()
            .find(|e| e.name == name)
    ...
    use waybill_common::resolution::BuildInclusion;
