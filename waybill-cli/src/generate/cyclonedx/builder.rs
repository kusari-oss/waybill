...
pub struct CycloneDxBuilder {
    ...
    collisions_summary:
        Option<waybill_common::divergence::CollisionsSummary>,
...
impl CycloneDxBuilder {
    ...
    pub fn with_collisions_summary(
        mut self,
        summary: Option<waybill_common::divergence::CollisionsSummary>,
    ) -> Self {
    ...
    pub fn with_user_metadata(
        mut self,
        m: waybill::binding::user_metadata::UserMetadata,
    ) -> Self {
    ...
    pub fn with_source_document_binding(
        mut self,
        id: Option<waybill::binding::SourceDocumentId>,
    ) -> Self {
    ...
    pub fn with_identifiers(
        mut self,
        ids: Vec<waybill::binding::identifiers::Identifier>,
    ) -> Self {
    ...
    pub fn with_component_identifiers(
        mut self,
        ids: Vec<
            waybill::binding::identifiers::component_id::ComponentIdentifierFlag,
        >,
    ) -> Self {
...
mod tests {
    ...
    fn evidence_tools_field_absent_from_serialized_output() {
        ...
        component.evidence.deps_dev_match = Some(
            waybill_common::resolution::DepsDevMatch {
    ...
    fn component_with_single_spdx_license_emits_id_form_with_acknowledgement() {
        ...
        component.licenses = vec![
            waybill_common::types::license::SpdxExpression::new("MIT").unwrap(),
        ];
        let integrity = clean_integrity();
    ...
    fn concluded_licenses_can_differ_from_declared() {
        ...
        component.concluded_licenses = vec![
            waybill_common::types::license::SpdxExpression::new("Apache-2.0").unwrap(),
        ];
        let integrity = clean_integrity();
