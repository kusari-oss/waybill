...
pub struct ScanArtifacts<'a> {
    ...
    pub identifiers:
        &'a [waybill::binding::identifiers::Identifier],
    ...
    pub component_identifiers:
        &'a [waybill::binding::identifiers::component_id::ComponentIdentifierFlag],
    ...
    pub collisions_summary:
        Option<&'a waybill_common::divergence::CollisionsSummary>,
