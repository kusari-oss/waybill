...
spdx3_anno!(c135_spdx3, "waybill:package-shape",                    component);
spdx3_anno!(c136_spdx3, "waybill:go-toolchain-detected",            document);
...
// Milestone 221 US3 (FR-011 + FR-012): C141 doc-scope CISA 2026 lifecycle alias.
...
spdx3_anno!(c147_spdx3, "waybill:gradle-fallback-reason",                document);
// Milestone 235 US4 follow-on: C148 per-component Gradle subproject-tier.
spdx3_anno!(c148_spdx3, "waybill:gradle-subproject-tier",                component);
// Milestone 235 US4 follow-on: C149 per-component cache-freshness.
spdx3_anno!(c149_spdx3, "waybill:cache-freshness",                       component);
// Milestone 235 US4 follow-on: C150 per-component Gradle platform-import.
spdx3_anno!(c150_spdx3, "waybill:gradle-platform-import",                component);
// Milestone 236: C151 per-component unresolved-reason (all design-tier readers).
spdx3_anno!(c151_spdx3, "waybill:unresolved-reason",                     component);
