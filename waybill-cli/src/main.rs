...
/// Maps to `waybill_common::resolution::LifecycleScope` non-Runtime
...
impl ExcludeScopeArg {
    pub fn as_lifecycle_scope(self) -> waybill_common::resolution::LifecycleScope {
...
async fn main() -> anyhow::Result<std::process::ExitCode> {
    ...
    let exclude_scope: Vec<waybill_common::resolution::LifecycleScope> =
