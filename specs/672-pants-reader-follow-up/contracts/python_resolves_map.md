...
[python.resolves.internal-libs]
path = "3rdparty/python/internal-libs.lock"
...
| `[python.resolves.internal-libs] path = "..."` (table shape) | WARN naming `internal-libs` + `table`; entry skipped | C3 |
